...
- [The possibility of an "HTML5" specification is mentioned](http://lists.w3.org/Archives/Public/public-whatwg-archive/2004Aug/0345.html);
  ...
  later reply on the same list, Ian Hickson says that
  ["at this point Web Apps [the Web Applications 1.0 spec] is basically HTML5"](http://lists.w3.org/Archives/Public/public-whatwg-archive/2004Nov/0030.html).
